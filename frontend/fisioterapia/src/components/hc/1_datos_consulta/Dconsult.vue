      ...
      <div class="accordion-body">
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profileA"
        ...
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane fade show active" id="nav-profileA" role="tabpanel" aria-labelledby="nav-profile-tab"
            tabindex="0">
            <div>
              <div class="mb-3">
                <br />
                <textarea placeholder="Motivo de Consulta" v-model="motivoConsulta" class="form-control textarea"
                  id="text_motivoconsulta" rows="3"></textarea>
              </div>

              <div class="mb-3">
                <textarea placeholder="Enfermedad actual" v-model="Enfermedad" class="form-control textarea"
                  id="text_diagnosticomedico" rows="3"></textarea>
              </div>

              <div class="mb-3">
                <textarea placeholder="Tratamientos Previos" v-model="TratPrevios" class="form-control textarea"
                  id="text_tratamientosprevios" rows="3"></textarea>
              </div>

              <div class="mb-3">
                <textarea placeholder="Medicamentos Previos" v-model="MedPrevios" class="form-control textarea"
                  id="text_medicamentosprevios" rows="3"></textarea>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <div>
                    <div class="input-group mb-1">
                      <input type="number" class="form-control form-control-sm textarea" id="text_peso" v-model="peso"
                        placeholder="Peso (kg)" />
                    </div>
                    <div class="input-group mb-1">
                      <input type="number" class="form-control form-control-sm textarea" id="text_talla" v-model="talla"
                        placeholder="Talla (Cm)" />
                    </div>
                    <div class="input-group mb-1">
                      <input type="number" class="form-control form-control-sm textarea" id="text_estatura"
                        v-model="estatura" placeholder="Estatura (Cm)" />
                    </div>
                    <div class="input-group mb-1">
                      <input type="number" class="form-control form-control-sm textarea" id="text_imc" v-model="imc"
                        placeholder="IMC" />
                    </div>
                  </div>
                </div>
                ...
                <div class="col-6">
                  <p>Signos Vitales</p>
                  <div class="mb-1">
                    <input type="number" class="form-control form-control-sm textarea" id="text_temp" v-model="temp"
                      placeholder="Temp (C)" />
                  </div>
                  <div class="mb-1">
                    <input type="number" class="form-control form-control-sm textarea" id="text_fcardiaca"
                      v-model="fcardiaca" placeholder="F.cardiaca" />
                  </div>
                  <div class="mb-1">
                    <input type="number" class="form-control form-control-sm textarea" id="text_frespiratoria"
                      v-model="frespiratoria" placeholder="F.respiraotria" />
                  </div>
                  <div class="mb-1">
                    <input type="number" class="form-control form-control-sm textarea" id="text_tarterial"
                      v-model="tarterial" placeholder="T.Arterial" />
                  </div>
                </div>
              </div>
            </div>
...
<!-- combo select antecedentes -->
              <div class="col-12 col-md-6">
                ...
                <div>
                  ...
                  <select v-model="selectenfermedad" class="form-select form-select-sm textarea" id="selectenfermedad"
