      ...
      <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active m-3" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"
          ...
          <div class="container">
            ...
            <button type="button" class="btn btn-primary btn-sm" @click="AddAntec('piel', i_est_piel, detalle_piel)">
              + Adicionar
            </button>
          </div>
        </div>
            ...
            <div class="row g-3 align-items-center">
              <div class="col-12 col-md-6">
                <div class="img-container">
                  <img id="imagen_postura" src="./../../../assets/images/insp_estatica/imagen_biotipo.png"
                    alt="Imagen biotipo" class="img-fluid rounded" />
                </div>
              </div>
              <div class="col-12 col-md-6">
        ...
        <div class="tab-pane fade m-3" id="nav-disabled" role="tabpanel" aria-labelledby="nav-disabled-tab"
          tabindex="0">
          <div class="container">
            <div class="row g-3 align-items-center">
              <div class="col-12 col-md-6">
                <div class="img-container">
                  <img id="imagen_postura" src="./../../../assets/images/insp_estatica/imagen_postura.png"
                    alt="Imagen postura" class="img-fluid rounded" />
                </div>
              </div>
              <div class="col-12 col-md-6">
