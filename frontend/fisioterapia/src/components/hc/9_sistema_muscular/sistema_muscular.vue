        ...
        <div class="container">
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button class="nav-link active" id="nav-sist-muscular" data-bs-toggle="tab"
                data-bs-target="#nav-smuscular" type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                Sistema Muscular
              </button>
              <button class="nav-link" id="nav-sist-muscular-general" data-bs-toggle="tab"
                data-bs-target="#nav-smusculargen" type="button" role="tab" aria-controls="nav-profile"
                aria-selected="false">
                Eval Musc General
              </button>
              <button class="nav-link" id="nav-sist-muscular-detalle" data-bs-toggle="tab"
                data-bs-target="#nav-smusculardetall" type="button" role="tab" aria-controls="nav-contact"
                aria-selected="false">
                Eval Musc Detallada
              </button>
            </div>
          ...
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-smuscular" role="tabpanel"
              aria-labelledby="nav-sist-muscular" tabindex="0">
              <div class="container">
                <br />
                <div class="row">
                  <div class="col-12 col-md-6">
                    <div class="mb-1">
                      <!--  -->
                      <select v-model="tipoevaluacionM" class="form-select form-select-sm textarea" id="tipoevaluacionM"
                        @change="
                          busquedamuscular(
                            tipoevaluacionM,
                            data_smuscular,
                        ...
                        <option v-for="(item, index) in data_smuscular" :key="index" :value="item.clase">
                          {{ item.clase }}
                        </option>
                      </select>
                    </div>
                  ...
                  <div class="col-12 col-md-6">
                    <div class="mb-1">
                      <!--  -->
                      <select v-model="caracteristicaM" class="form-select form-select-sm textarea" id="gmuscular"
                        aria-label="Default select example">
                ...
                <div class="mb-1">
                  <textarea class="form-control form-control-sm textarea" id="exampleFormControlTextarea1"
                    placeholder="Detalle" v-model="detalleM"></textarea>
                </div>
            ...
            <div class="tab-pane fade" id="nav-smusculargen" role="tabpanel" aria-labelledby="nav-sist-muscular-general"
              tabindex="0">
              <div class="container">
                <br />
                <div class="row">
                  <div class="col-12 col-md-5">
                    <div class="mb-1">
                      <select class="form-select form-select-sm textarea" id="emuscular"
                        aria-label="Small select example" v-model="emuscular" @change="
                          evalmuscular(emuscular, data_emuscular, 'musculo')
                          ">
                        <option value="0">--Seleccione clase--</option>
                        <option v-for="item in data_emuscular" :key="item.id" :value="item.id">
                          {{ item.clase }}
                        </option>
                      </select>
                    </div>
                  ...
                  <div class="col-12 col-md-5">
                    <div class="mb-1">
                      <select class="form-select form-select-sm textarea" id="emuscular_musc"
                        aria-label="Small select example" v-model="musculo">
                  ...
                  <div class="col-12 col-md-2">
                    <div class="mb-1">
                      <select v-model="eval_grado" class="form-select form-select-sm textarea" id="Ggmuscular"
            ...
            <div class="tab-pane fade" id="nav-smusculardetall" role="tabpanel"
              aria-labelledby="nav-sist-muscular-detalle" tabindex="0">
              <div class="container">
                <div class="accordion" id="accordionExpMuscular">
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseCuello" aria-expanded="true" aria-controls="collapsCuello">
                        Cuello
                      </button>
                    </h2>
                    <div id="collapseCuello" class="accordion-collapse collapse show"
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <input type="number" placeholder="Grado" class="form-control" />
                                </td>
                                <td>
                                  <input type="number" placeholder="Grado" class="form-control" />
                                </td>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseTronco" aria-expanded="false" aria-controls="collapseTronco">
                        Tronco
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseHombro" aria-expanded="false" aria-controls="collapseHombro">
                        Hombro
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseCodo" aria-expanded="false" aria-controls="collapseCodo">
                        Codo
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseMuneca" aria-expanded="false" aria-controls="collapseMuneca">
                        Muñeca
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseDedos" aria-expanded="false" aria-controls="collapseDedos">
                        Dedos de la mano
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseCadera" aria-expanded="false" aria-controls="collapseCadera">
                        Cadera
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseRodilla" aria-expanded="false" aria-controls="collapseRodilla">
                        Rodilla
                      </button>
                    </h2>
                    <div id="collapseRodilla" class="accordion-collapse collapse"
                      data-bs-parent="#accordionExpMuscular">
                      <div class="accordion-body">
                        <div class="card">
                          <table class="table">
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapseTobillo" aria-expanded="false" aria-controls="collapseTobillo">
                        Tobillo
                      </button>
                    </h2>
                    <div id="collapseTobillo" class="accordion-collapse collapse"
                      data-bs-parent="#accordionExpMuscular">
                      <div class="accordion-body">
                        <div class="card">
                          <table class="table">
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                          data-bs-target="#collapsededospies" aria-expanded="false" aria-controls="collapsededospies">
                          Dedos de los Pies
                        </button>
                      </h2>
                      <div id="collapsededospies" class="accordion-collapse collapse"
                        data-bs-parent="#accordionExpMuscular">
                        <div class="accordion-body">
                          <div class="card">
                            <table class="table">
